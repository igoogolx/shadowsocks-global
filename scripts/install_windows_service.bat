...
:: Stops/uninstalls and starts/reinstalls ShadowsocksGlobalService.
...
net stop ShadowsocksGlobalService
sc delete ShadowsocksGlobalService
...
sc create ShadowsocksGlobalService binpath= "%PWD%ShadowsocksGlobalService.exe" displayname= "ShadowsocksGlobalService" start= "auto"
net start ShadowsocksGlobalService
